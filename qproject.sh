...
# apngasm output.apng frames/*.png -d 2000  # 2000ms per frame
# apngasm output.apng frames/*.png -d 1600  # 1600ms per frame
# apngasm output.apng frames/*.png -d 1600  # 1200ms per frame
