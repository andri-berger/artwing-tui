...
from textual.widgets import Button, ContentSwitcher, DataTable, DirectoryTree, Input, Label
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(id="layer-1"):
            with ContentSwitcher(id="cont-switch-0", initial="dir-tree-0"):
                yield FileTree("/", file_type="file-0", id="dir-tree-0")

            with ContentSwitcher(id="cont-switch-1", initial="dir-tree-1"):
                yield FileTree("Fontend", file_type="file-1", id="dir-tree-1")

            with ContentSwitcher(id="cont-switch-2", initial="dir-tree-2"):
                yield FileTree("Fontend/_blank", file_type="file-2", id="dir-tree-2")

            with ContentSwitcher(id="cont-switch-3", initial="data-table"):
                yield DataTable(show_header=False, id="data-table")
